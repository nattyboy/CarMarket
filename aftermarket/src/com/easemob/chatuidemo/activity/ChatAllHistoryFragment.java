...
public class ChatAllHistoryFragment extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		backImg=(ImageView) getView().findViewById(R.id.imageView_back);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (username.equals(DemoApplication.getInstance().getUserName()))
					...
					Log.e("oye", "ustId"+username);
					Log.e("dajiayilian", "share执行到这里了onlineAsk"+store_img);
					...
					if (conversation.isGroup()) {
						...
						intent.putExtra("store_img", adapter.getImg());
						intent.putExtra("cmp_name", cmp_name);
						intent.putExtra("merchant_id", merchant_id);
						intent.putExtra("balance", balance);
						intent.putExtra("store_img", store_img);
