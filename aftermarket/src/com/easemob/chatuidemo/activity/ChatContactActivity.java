...
public class ChatContactActivity extends BaseActivity implements EMEventListener {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if (ChatActivity.activityInstance != null && usernameList.contains(ChatActivity.activityInstance.getToChatUsername())) {
						Toast.makeText(ChatContactActivity.this, ChatActivity.activityInstance.getToChatUsername() + st10, 1).show();
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
					if (error == EMError.USER_REMOVED) {
						...
						if (NetUtils.hasNetwork(ChatContactActivity.this))
		...
		public void onInvitationReceived(String groupId, String groupName, String inviter, String reason) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if (currentTabIndex == 0)
						chatHistoryFragment.refresh();
					if (CommonUtils.getTopActivity(ChatContactActivity.this).equals(GroupsActivity.class.getName())) {
	...
	/*
	 * @Override protected void onResume() { super.onResume(); if (!isConflict
	 * && !isCurrentAccountRemoved) { updateUnreadLabel();
	 * updateUnreadAddressLable();
	 * EMChatManager.getInstance().activityResumed(); }
	 * 
	 * // unregister this event listener when this activity enters the
	 * background DemoHXSDKHelper sdkHelper = (DemoHXSDKHelper)
	 * DemoHXSDKHelper.getInstance(); sdkHelper.pushActivity(this);
	 * 
	 * // register the event listener when enter the foreground
	 * EMChatManager.getInstance().registerEventListener(this,new
	 * EMNotifierEvent.Event[]{EMNotifierEvent.Event.EventNewMessage}); }
	 * 
	 * @Override protected void onStop(){
	 * EMChatManager.getInstance().unregisterEventListener(this);
	 * DemoHXSDKHelper sdkHelper = (DemoHXSDKHelper)
	 * DemoHXSDKHelper.getInstance(); sdkHelper.popActivity(this);
	 * 
	 * super.onStop(); }
	 * 
	 ...
	 * (keyCode == KeyEvent.KEYCODE_BACK) { moveTaskToBack(false); return true;
	...
	private void showConflictDialog() {
		...
		if (!ChatContactActivity.this.isFinishing()) {
			// clear up global variables
			try {
				if (conflictBuilder == null)
					conflictBuilder = new android.app.AlertDialog.Builder(ChatContactActivity.this);
				...
				conflictBuilder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						conflictBuilder = null;
						finish();
						startActivity(new Intent(ChatContactActivity.this, ShopLoginActivity.class));
					}
				});
		...
		if (!ChatContactActivity.this.isFinishing()) {
			...
			try {
				if (accountRemovedBuilder == null)
					accountRemovedBuilder = new android.app.AlertDialog.Builder(ChatContactActivity.this);
