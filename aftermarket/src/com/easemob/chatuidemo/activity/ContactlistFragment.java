		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (Constant.NEW_FRIENDS_USERNAME.equals(username)) {
					...
					SharedPreferences  sp = getActivity().getSharedPreferences(adapter.getItem(position).getUsername(), Context.MODE_PRIVATE);
					...
					Log.e("share", "ustId"+adapter.getItem(position).getUsername()+balance);
					Log.e("dajiayilian", "share执行到这里了onlineAsk");
