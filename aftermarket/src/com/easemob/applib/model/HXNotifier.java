...
public class HXNotifier {
	 ...
	 * @param message
	 */
	protected void sendNotification(final EMMessage message, final boolean isForeground) {

		HttpUtils httpUtils = new HttpUtils();
		String url = ConstantClass.NET_URL + REQUEST_HEADER;
		RequestParams params = new RequestParams();
		// String username = message.getFrom();
		params.addBodyParameter("user", message.getFrom());
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				try {
					if ("1".equals(String.valueOf(jsonObj.getInt("code")))) {
						...
						notifyFunction(easeMobData.data.get(0).user_name, message, isForeground);
	...
	public void notifyFunction(String username, EMMessage message, boolean isForeground) {
