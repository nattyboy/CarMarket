...
import com.example.aftermarket.photo.adapter.AlbumGridViewAdapter;
import com.example.aftermarket.photo.util.AlbumHelper;
import com.example.aftermarket.photo.util.Bimp;
import com.example.aftermarket.photo.util.ImageBucket;
...
public class AlbumActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		activiytString = intent.getStringExtra("AlbumActivity");
	...
	private class AlbumSendListener implements OnClickListener {
		public void onClick(View v) {
			...
			if ("FeedBackActivity".equals(activiytString)) {
				intent.setClass(mContext, FeedBackActivity.class);
			} else {
				intent.setClass(mContext, AskToRefundActivity.class);
			}
