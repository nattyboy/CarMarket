 ...
 */
public class BeautifulActivity extends Activity implements OnLayoutChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		activityRootView = findViewById(R.id.relative_beautiful);
		// 获取屏幕高度
		...
		sendBt = (Button) findViewById(R.id.click_button_beautiful);
		chooseCarLayout = (RelativeLayout) findViewById(R.id.mycar_beauty_layout);
		dim_id = getIntent().getStringExtra("dim_id");
		editBeauty = (EditText) findViewById(R.id.edit_beauty_car);

		myCarTv = (TextView) findViewById(R.id.mycar_tv_beauty);
		time = (RelativeLayout) findViewById(R.id.time_beauty);
		Ll_all = (RelativeLayout) findViewById(R.id.relative_beautiful);
		gridView = (NoScrollGridView) findViewById(R.id.gridView_beauty);
		adapter = new SquareAdapter(BeautifulActivity.this, 0);
		...
		time.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				View view = View.inflate(BeautifulActivity.this, R.layout.dialog_select_time, null);
	...
	public void showPopUp() {
		...
		mFloatLayout.setVisibility(View.INVISIBLE);
		// 更新头像
		pop = new PopupWindow(BeautifulActivity.this);
		...
		View parentView = getLayoutInflater().inflate(R.layout.activity_beautiful, null);
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				try {
					if ("1".equals(String.valueOf(jsonObj.getInt("code")))) {
						...
						// Token过期请重新登录
						Toast.makeText(BeautifulActivity.this, "请登录", Toast.LENGTH_SHORT).show();
						Intent intent = new Intent(BeautifulActivity.this, ShopLoginActivity.class);
						startActivity(intent);
					} else {
	...
	private void createFloatView() {
		...
		mFloatView.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(BeautifulActivity.this, SellerActivity.class);
				mWindowManager.removeView(mFloatLayout);
	...
	protected void onNewIntent(Intent intent) {
		...
		myCarTv = (TextView) findViewById(R.id.mycar_tv_beauty);
		if (null != intent.getStringExtra("car_version_beauty")) {
			myCarTv.setText(intent.getStringExtra("car_category_name_beauty"));
			category_id = intent.getStringExtra("car_category_id_beauty");
			category_name = intent.getStringExtra("car_category_name_beauty");
	...
	public void onclickSend(View view) {
		...
		if (TextUtils.isEmpty(category_name)) {
			Toast.makeText(BeautifulActivity.this, "请选择车型", Toast.LENGTH_SHORT).show();
			return;
		}

		/*
		 * if (TextUtils.isEmpty(adapterName.returnCheckTextList())) {
		 * Toast.makeText(BeautifulActivity.this, "请选择服务项目",
		 * Toast.LENGTH_SHORT).show(); return; } if
		 * (TextUtils.isEmpty(timeTv.getText())) {
		 * Toast.makeText(BeautifulActivity.this, "请选择预约时间",
		 * Toast.LENGTH_SHORT).show(); return; }
		 */
		if (TextUtils.isEmpty(editBeauty.getText())) {
			Toast.makeText(BeautifulActivity.this, "请输入具体需求", Toast.LENGTH_SHORT).show();
			return;
		}
	...
	private void uploadData() {
		...
		params.addBodyParameter("content", editBeauty.getText().toString());
	...
	public void changeMyCar(View view) {
		...
		if (null != app.getToken()) {
			Intent intent = new Intent(BeautifulActivity.this, MyCarPortActivity.class);
			intent.putExtra("choose_car_beauty", "choose_car_beauty");
			startActivity(intent);
		} else {
			Toast.makeText(BeautifulActivity.this, "请登录", Toast.LENGTH_SHORT).show();
			Intent intent = new Intent(BeautifulActivity.this, ShopLoginActivity.class);
	...
	public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
		...
		if (oldBottom != 0 && bottom != 0 && (oldBottom - bottom > keyHeight)) {
			...
			mFloatLayout.setVisibility(View.INVISIBLE);
			findViewById(R.id.up_load_beautif).setVisibility(View.VISIBLE);
			findViewById(R.id.send_beautif).setVisibility(View.GONE);
			findViewById(R.id.title_beautiful).setVisibility(View.VISIBLE);
			...
			mFloatLayout.setVisibility(View.VISIBLE);
			findViewById(R.id.up_load_beautif).setVisibility(View.VISIBLE);
			findViewById(R.id.send_beautif).setVisibility(View.VISIBLE);
			findViewById(R.id.title_beautiful).setVisibility(View.VISIBLE);
		}
	}
