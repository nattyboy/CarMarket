...
public class SquareAdapterGridItem extends BaseAdapter {
	...
	public SquareAdapterGridItem(Context context, int status) {
		// 测试数据
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (mContext instanceof SellerInfoActivity) {
			vr.mybox.setClickable(false);
		}
