...
package com.timepick.wheel.widget;
...
public class WheelView extends View {
	 ...
	 */
	private static final int ITEM_OFFSET =0;// TEXT_SIZE / 10;
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.calen_wheel_val);
		}
		...
		setBackgroundResource(R.drawable.calen_wheel_bg);
	}
